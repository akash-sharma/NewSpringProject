...
public class SchemaUpdate {
	...
	public SchemaUpdate(ServiceRegistry serviceRegistry, Configuration cfg)
			throws HibernateException {
		this.configuration = cfg;

		final JdbcServices jdbcServices = serviceRegistry
	...
	public void execute() {
		...
		try {
			...
			List<SchemaUpdateScript> scripts = configuration
					.generateSchemaUpdateScriptList(dialect, meta);
...
class ManagedProviderConnectionHelper implements ConnectionHelper {
	...
	public void prepare(boolean needsAutoCommit) throws SQLException {
		...
		connection = serviceRegistry.getService(ConnectionProvider.class)
				.getConnection();
...
class SuppliedConnectionProviderConnectionHelper implements ConnectionHelper {
	...
	public SuppliedConnectionProviderConnectionHelper(
